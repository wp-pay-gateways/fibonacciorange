 ...
 * @version 1.0.0
 */
class Pronamic_WP_Pay_Gateways_FibonacciOrange_IntegrationTest extends PHPUnit_Framework_TestCase {
	public function test_config() {
		$integration = new Pronamic_WP_Pay_Gateways_FibonacciOrange_Integration();
